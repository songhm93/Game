...
struct MaterialParams
{
	...
	array<int32, MATERIAL_ARG_COUNT> texOnParams; //텍스쳐를 사용하는지 안하는지를 체크하기 위함.
	array<Vec2, MATERIAL_ARG_COUNT> vec2Params; //float,float을 묶음
	array<Vec4, MATERIAL_ARG_COUNT> vec4Params; //float,float을 묶음
